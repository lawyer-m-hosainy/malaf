...
// التحقق من رقم الجوال المصري (+201xxxxxxxxx أو 01xxxxxxxxx) - السماح بمسافات اختيارية
...
export const caseSchema = z.object({
  ...
  plaintiff: z.string().optional().or(z.literal('')),
  defendant: z.string().optional().or(z.literal('')),
