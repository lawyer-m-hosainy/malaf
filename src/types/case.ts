...
export type EgyptCaseCategory = 
  ...
  | 'اقتصادي'
  | 'عقاري'
  // R7-FIX: أنواع مفقودة — قانون المرافعات المصري
  | 'إيجارات'    // دعاوى الإيجارات (القانون 49/1977 و 136/1981)
  | 'ضرائب'      // طعون ضريبية (أمام لجان الطعن ومحكمة الضرائب)
  | 'تأديبي';    // المحاكم التأديبية (مجلس الدولة / النيابة الإدارية)
...
export interface Case {
  ...
  status: 'متداولة' | 'مغلقة' | 'تحت الدراسة' | 'محفوظة' | 'حكم نهائي'
    ...
    | 'مستأنفة'     // تم استئنافها
    | 'طعن'         // مطعون عليها بالنقض
    | 'تنفيذ';      // تحت التنفيذ القضائي
