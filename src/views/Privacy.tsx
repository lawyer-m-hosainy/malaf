...
/**
 * مكون فرعي لعرض البيانات المجمعة والمعالجين الثانويين باللغة العربية.
 * @returns {React.ReactElement} عنصر واجهة مستخدم البيانات والمعالجات
 */
function ArabicPrivacyDataAndProcessors() {
  return (
...
/**
 * مكون فرعي لعرض الحقوق القانونية وتفاصيل الاتصال باللغة العربية.
 * @returns {React.ReactElement} عنصر واجهة مستخدم الحقوق والتواصل
 */
function ArabicPrivacyRightsAndRetention() {
  return (
    <>
      ...
      <div className="mt-12 p-6 bg-primary-50 dark:bg-primary-900/10 rounded-xl border border-primary-100 dark:border-primary-900/20 text-center">
        <h4 className="font-bold text-primary-900 dark:text-primary-100">ل للتواصل مع مسؤول حماية البيانات (DPO)</h4>
...
/**
 * مكون فرعي لتجميع المحتوى العربي للسياسة.
 * @returns {React.ReactElement} عنصر واجهة مستخدم المحتوى العربي
 */
function ArabicPrivacyContent() {
  return (
    <>
      ...
      <ArabicPrivacyDataAndProcessors />
      <ArabicPrivacyRightsAndRetention />
    </>
  );
}

/**
 * مكون فرعي لعرض البيانات المجمعة والمعالجين الثانويين باللغة الإنجليزية.
 * @returns {React.ReactElement} عنصر واجهة مستخدم البيانات والمعالجات بالإنجليزية
 */
function EnglishPrivacyDataAndProcessors() {
  return (
...
/**
 * مكون فرعي لعرض الحقوق وتفاصيل الاتصال باللغة الإنجليزية.
 * @returns {React.ReactElement} عنصر واجهة مستخدم الحقوق والتواصل بالإنجليزية
 */
function EnglishPrivacyRightsAndRetention() {
  return (
...
/**
 * مكون فرعي لتجميع المحتوى الإنجليزي للسياسة.
 * @returns {React.ReactElement} عنصر واجهة مستخدم المحتوى الإنجليزي
 */
function EnglishPrivacyContent() {
  return (
    <div className="mt-8 space-y-6">
      ...
      <EnglishPrivacyDataAndProcessors />
      <EnglishPrivacyRightsAndRetention />
    </div>
  );
}
 ...
 * @returns {React.ReactElement} عنصر واجهة مستخدم صفحة سياسة الخصوصية
 */
