-- ═══════════════════════════════════════════════════════════════════ 
 -- Migration 023: Update Subscription Plan Prices and Sort Order 
 -- ═══════════════════════════════════════════════════════════════════ 
 -- التاريخ: 2026-05-12 
 -- الوصف: تحديث أسعار الباقات وترتيب عرضها في Onboarding 
 ...
 -- 2. تحديث الباقة المجانية (free) لتكون في الترتيب 0 
 UPDATE plan_limits SET sort_order = 0 WHERE plan_key = 'free'; 
 
 -- 3. تحديث الباقة المتقدمة (standard) لتكون 600 ج.م 
 ...
 -- 4. تحديث باقة المؤسسات (premium) لتكون 1300 ج.م 
 UPDATE plan_limits SET 
   price_monthly = 1300, 
   price_yearly = 13000, 
